...
enum class ShipmentStatus(
    ...
    SENT_FROM_SOURCE_BRANCH(R.string.status_sent_from_source_branch_en),
    AVIZO(R.string.status_avizo_small),
    CONFIRMED(R.string.status_confirmed_small),
    CREATED(R.string.status_created),
    DELIVERED(R.string.status_delivered),
    OTHER(R.string.status_other_en),
    OUT_FOR_DELIVERY(R.string.status_out_for_delivery_small),
    PICKUP_TIME_EXPIRED(R.string.status_pickup_time_expired),
    READY_TO_PICKUP(R.string.status_ready_to_pickup_small),
