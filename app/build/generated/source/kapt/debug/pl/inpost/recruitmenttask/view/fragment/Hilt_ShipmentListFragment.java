...
public abstract class Hilt_ShipmentListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ShipmentListFragment() {
    super();
  }

  Hilt_ShipmentListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ShipmentListFragment_GeneratedInjector) this.generatedComponent()).injectShipmentListFragment(UnsafeCasts.<ShipmentListFragment>unsafeCast(this));
    }
  }
